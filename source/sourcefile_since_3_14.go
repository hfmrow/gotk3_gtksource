...
const (
	...
	SOURCE_FILE_SAVER_ERROR_EXTERNALLY_MODIFIED                      = C.GTK_SOURCE_FILE_SAVER_ERROR_EXTERNALLY_MODIFIED
)
...
const (
	...
	SOURCE_FILE_SAVER_FLAGS_IGNORE_INVALID_CHARS                          = C.GTK_SOURCE_FILE_SAVER_FLAGS_IGNORE_INVALID_CHARS
	SOURCE_FILE_SAVER_FLAGS_IGNORE_MODIFICATION_TIME                      = C.GTK_SOURCE_FILE_SAVER_FLAGS_IGNORE_MODIFICATION_TIME
	SOURCE_FILE_SAVER_FLAGS_CREATE_BACKUP                                 = C.GTK_SOURCE_FILE_SAVER_FLAGS_CREATE_BACKUP
)
...
const (
	...
	SOURCE_FILE_LOADER_ERROR_ENCODING_AUTO_DETECTION_FAILED                       = C.GTK_SOURCE_FILE_LOADER_ERROR_ENCODING_AUTO_DETECTION_FAILED
	SOURCE_FILE_LOADER_ERROR_CONVERSION_FALLBACK                                  = C.GTK_SOURCE_FILE_LOADER_ERROR_CONVERSION_FALLBACK
)
...
const (
	...
	SOURCE_NEWLINE_TYPE_CR                      = C.GTK_SOURCE_NEWLINE_TYPE_CR
	SOURCE_NEWLINE_TYPE_CR_LF                   = C.GTK_SOURCE_NEWLINE_TYPE_CR_LF
)
...
const (
	...
	SOURCE_COMPRESSION_TYPE_GZIP                       = C.GTK_SOURCE_COMPRESSION_TYPE_GZIP
)
