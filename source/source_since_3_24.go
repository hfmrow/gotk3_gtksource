...
// +build !gtk_sourceview_3_18,!gtk_sourceview_3_20,!gtk_sourceview_3_22
...
const (
	...
	SOURCE_SPACE_TYPE_SPACE                        = C.GTK_SOURCE_SPACE_TYPE_SPACE
	SOURCE_SPACE_TYPE_TAB                          = C.GTK_SOURCE_SPACE_TYPE_TAB
	SOURCE_SPACE_TYPE_NEWLINE                      = C.GTK_SOURCE_SPACE_TYPE_NEWLINE
	SOURCE_SPACE_TYPE_NBSP                         = C.GTK_SOURCE_SPACE_TYPE_NBSP
	SOURCE_SPACE_TYPE_ALL                          = C.GTK_SOURCE_SPACE_TYPE_ALL
)
...
const (
	...
	SOURCE_SPACE_LOCATION_LEADING                              = C.GTK_SOURCE_SPACE_LOCATION_LEADING
	SOURCE_SPACE_LOCATION_INSIDE_TEXT                          = C.GTK_SOURCE_SPACE_LOCATION_INSIDE_TEXT
	SOURCE_SPACE_LOCATION_TRAILING                             = C.GTK_SOURCE_SPACE_LOCATION_TRAILING
	SOURCE_SPACE_LOCATION_ALL                                  = C.GTK_SOURCE_SPACE_LOCATION_ALL
)
