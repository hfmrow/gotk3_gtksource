...
const (
	...
	SOURCE_SORT_FLAGS_CASE_SENSITIVE                    = C.GTK_SOURCE_SORT_FLAGS_CASE_SENSITIVE
	SOURCE_SORT_FLAGS_REVERSE_ORDER                     = C.GTK_SOURCE_SORT_FLAGS_REVERSE_ORDER
	SOURCE_SORT_FLAGS_REMOVE_DUPLICATES                 = C.GTK_SOURCE_SORT_FLAGS_REMOVE_DUPLICATES
)
