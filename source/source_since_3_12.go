...
const (
	...
	SOURCE_CHANGE_CASE_UPPER                       = C.GTK_SOURCE_CHANGE_CASE_UPPER
	SOURCE_CHANGE_CASE_TOGGLE                      = C.GTK_SOURCE_CHANGE_CASE_TOGGLE
	SOURCE_CHANGE_CASE_TITLE                       = C.GTK_SOURCE_CHANGE_CASE_TITLE
)
